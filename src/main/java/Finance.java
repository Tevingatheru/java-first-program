...
public class Finance {
    ...
    /**
     * This method execute existing command-line apps based on what inputs you receive from the user.
     */
    ...
    public static void main(String[] args) {
        ...
        boolean isValidCommand  = commandsToUsage.containsKey(command);
